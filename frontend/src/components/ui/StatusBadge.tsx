...
type Status = 'online' | 'offline' | 'warning' | 'error' | 'processing' | 'idle' | 'success'
...
const cfg: Record<Status, { dot: string; text: string; fallback: string }> = {
  ...
  success: { dot: 'bg-success', text: 'text-success', fallback: 'OK' },
  ...
  processing: { dot: 'bg-info animate-pulse', text: 'text-info', fallback: 'Running' },
